 ...
 * Time: 2:13:37 AM
 */
public class ConcursUtile {
    public static void salveazaClasament(String numefis,List<Participant> parts) throws ConcursExceptie {
        PrintWriter pw=null;
        try{
            ...
            throw new ConcursExceptie("NU se poate salva clasamentul"+e);
        }finally {
            if(pw!=null){
                pw.close();
            }
